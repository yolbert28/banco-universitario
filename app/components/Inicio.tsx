...
export function Presentacion({title, description}: PresentacionProps) {
  ...
  return (
    ...
    >
      <div className="max-w-[1650px] w-full h-full relative bg-cover max-[410px]:bg-position-[-25vw_center] max-[450px]:bg-position-[-20vw_center] max-[540px]:bg-position-[-10vw_center] sm:bg-position-[-0vw_center] md:bg-position-[0vw_bottom] bg-[url('/images/inicio.webp')] scale-x-[-1]">
